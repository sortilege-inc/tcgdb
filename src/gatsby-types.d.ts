...
type CardLookupAllQueryVariables = Exact<{ [key: string]: never; }>;


type CardLookupAllQuery = { readonly allCard: { readonly nodes: ReadonlyArray<{ readonly cardId: string, readonly gameId: string, readonly name: string, readonly imagePath: string | null }> } };
...
type CardsIndexQuery = { readonly allCard: { readonly nodes: ReadonlyArray<{ readonly cardId: string, readonly setId: string, readonly name: string, readonly nameAscii: string | null, readonly type: string, readonly unique: boolean | null, readonly text: string | null, readonly clan: string | null, readonly deck: string | null, readonly faction: string | null, readonly cost: number | null, readonly military: string | null, readonly political: string | null, readonly militaryBonus: string | null, readonly politicalBonus: string | null, readonly glory: number | null, readonly strength: number | null, readonly influence: number | null, readonly element: string | null, readonly elements: ReadonlyArray<string | null> | null, readonly traits: ReadonlyArray<string | null> | null, readonly traitsAscii: ReadonlyArray<string | null> | null }> }, readonly allCardSet: { readonly nodes: ReadonlyArray<{ readonly setId: string, readonly name: string, readonly cycle: string | null, readonly parentSetId: string | null, readonly type: string }> } };
...
type DeckDetailQuery = { readonly allCard: { readonly nodes: ReadonlyArray<{ readonly cardId: string, readonly gameId: string, readonly setId: string, readonly publisherId: string, readonly name: string, readonly nameAscii: string | null, readonly type: string, readonly unique: boolean | null, readonly text: string | null, readonly flavorText: string | null, readonly illustrator: string | null, readonly clan: string | null, readonly deck: string | null, readonly faction: string | null, readonly side: string | null, readonly cost: number | null, readonly military: string | null, readonly political: string | null, readonly militaryBonus: string | null, readonly politicalBonus: string | null, readonly glory: number | null, readonly strength: number | null, readonly influence: number | null, readonly influencePool: number | null, readonly honor: number | null, readonly fateIncome: number | null, readonly element: string | null, readonly elements: ReadonlyArray<string | null> | null, readonly traits: ReadonlyArray<string | null> | null, readonly traitsAscii: ReadonlyArray<string | null> | null, readonly deckLimit: number | null, readonly roleClassifier: string | null, readonly roleRing: string | null, readonly roleClan: string | null, readonly influenceBonus: number | null, readonly forcesSplashClan: string | null, readonly legalIn: { readonly standard: string | null, readonly stronghold: string | null, readonly skirmish: string | null } | null, readonly roleRestriction: { readonly ring: string | null, readonly type: string | null, readonly clan: string | null } | null }> }, readonly allCardSet: { readonly nodes: ReadonlyArray<{ readonly setId: string, readonly name: string, readonly type: string, readonly cycle: string | null }> } };
